package com.project.webservices.config;
...
public class KafkaConfiguration {
    ...
    public KafkaTemplate<String, Webhook> kafkaTemplate() {
        return new KafkaTemplate<String, Webhook>(producerFactory());
    }
    ...
    public ConsumerFactory<String, Webhook> consumerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, Webhook.class);
